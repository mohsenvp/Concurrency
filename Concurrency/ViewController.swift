...
//  Concurrency
//
//  Created by Mohsen Sedaghatfard on 10/16/21.
//
...
class ViewController: UIViewController {
    ...
    @IBAction func serialQueuePressed(_ sender: Any) {
        serialQueue()
    }
    
    @IBAction func mainThreadPressed(_ sender: Any) {
        regularDownload()
    }
    ...
    @IBAction func blockOperationQueuePressed(_ sender: Any) {
                blockOperationQueue()
